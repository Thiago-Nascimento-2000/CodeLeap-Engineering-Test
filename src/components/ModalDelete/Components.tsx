...
export const Container = ({ children }: ContainerProps) => {
  return (
    <div className="w-full sm:w-[660px] h-[146px] flex flex-col justify-between p-5 bg-white rounded-[16px] absolute top-[50%] left-[50%] transform -translate-x-[50%] -translate-y-[50%] shadow-lg">
      {children}
    </div>
  );
};
